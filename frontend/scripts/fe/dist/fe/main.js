...
var BorrowedBooksComponent = /** @class */ (function () {
    ...
    BorrowedBooksComponent.prototype.returnBook = function (item) {
        // ADD SIMPLEMODAL SERVICE CONFIRMATION BEFORE CALL
        this.booksService.returnBook({ book_id: item.book.id }).subscribe(function (data) {
...
/* harmony import */ var src_app_commons_forms_search_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/commons/forms/search.forms */ "./src/app/commons/forms/search.forms.ts");
/* harmony import */ var src_app_commons_models_search_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/commons/models/search.model */ "./src/app/commons/models/search.model.ts");
/* harmony import */ var _partials_modals_update_book_update_book_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../partials/modals/update-book/update-book.component */ "./src/app/components/partials/modals/update-book/update-book.component.ts");
...
var OwnedBooksComponent = /** @class */ (function () {
    ...
    OwnedBooksComponent.prototype.ngOnInit = function () {
        ...
        this.form = new src_app_commons_forms_search_forms__WEBPACK_IMPORTED_MODULE_4__["SearchForm"](new src_app_commons_models_search_model__WEBPACK_IMPORTED_MODULE_5__["SearchModel"]);
    ...
    OwnedBooksComponent.prototype.updateBook = function (book) {
        var _this = this;
        this.simpleModalService.addModal(_partials_modals_update_book_update_book_component__WEBPACK_IMPORTED_MODULE_6__["UpdateBookComponent"], { book: book }).subscribe(function (bookData) {
            if (bookData) {
                _this.simpleModalService.addModal(_partials_modals_confirmation_message_confirmation_message_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmationMessageComponent"], { has_error: false }).subscribe(function (isTrue) {
                    if (isTrue) {
